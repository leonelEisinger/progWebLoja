    ...
    <body>
        ...
        <form class="mx-auto w-25 text-align-center border px-2" action="salvaUsuario.php" method=post>
            ...
            <div class="mb-3">
                ...
                <input required class="form-control border border-dark" type= "text" value="<?=$usuario->getNome()?>" name="nome"/>
                <br>
            </div>
            <div class="mb-3">
                <label class="form-label" for="senha">Senha:</label>
                <input required class="form-control border border-dark" type= "text" value="<?=$usuario->getSenha()?>" name="senha"/>
                <br>
            </div>
            <div class="mb-3">
                <label class="form-label" for="email">Email:</label>
                <input required class="form-control border border-dark" type= "text" value="<?=$usuario->getEmail()?>" name="email"/>
                <br>
            </div>
            <div class="mb-3">
                <label class="form-label" for="telefone">Telefone:</label>
                <input required class="form-control border border-dark" type= "text" value="<?=$usuario->getTelefone()?>" name="telefone"/>
                <br>
            </div>
            <div class="mb-3">
